    ...
    <div className="w-full md:w-[900px] flex flex-col items-start justify-start gap-5">
      ...
      <div className="w-full md:w-[350px] h-auto pb-6 flex flex-col gap-2 bg-white shadow-xl rounded-md p-2">
        ...
        <h1 className="text-[15px] px-2 font-semibold">
          Raised <span className="text-red-500"> Rs {fundraiserDetails.raised} - </span> of Rs {fundraiserDetails?.raiseGoal}
        </h1>
        <div className="w-full h-auto">
          <div className="px-2">
            <div className="mt-5 flex flex-col items-start justify-between gap-2 font-extrabold text-[15px]">
              <h1>Input Money</h1>
              <input type="number" required placeholder="Enter Money" className="w-full border-2 border-red-400 p-2 rounded-lg" />
              {showPasswordInput && (
                <>
                  <h1>Confirm Password</h1>
                  <input type="text" required placeholder="Enter Password" className="w-full border-2 border-red-400 p-2 rounded-lg" />
                </>
              )}
            </div>
            <button
